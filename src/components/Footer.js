...
const Footer = () => {
  return (
<footer id='footer' class="bg-black pt-20 lg:pt-[120px] pb-10 lg:pb-20 absolute z-10 pl-32 w-full">
   <div class="container">
         ...
         <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
            <div class="w-full mb-10">
               <a
                  ...
                  class="inline-block max-w-[160px] mb-6 text-white text-2xl"
                  >
               PeakGo
               </a>
               <p class="text-body-color mb-7 text-white">
               1522 Cohoe Ct, Kenai, Alaska 99611, USA
               </p>
            ...
            <div class="w-full mb-10">
               ...
               <div class="flex items-center mb-6">
                  <a
                     ...
                     text-white hover:text-white hover:bg-primary hover:border-primary
                     mr-3
                     sm:mr-4
                     lg:mr-3
                     xl:mr-4
               ...
               <p class="text-white">&copy; 2025 PeakGo</p>
            </div>
         </div>
      </div>
   </div>
